...
Route::namespace('Api')->name('api.')->group(function(){
	...
	Route::namespace('Auth')->group(function(){
		Route::post('loginHeconomy', 'LoginController@loginHeconomy')->name('loginHeconomy');
	...
	Route::middleware('auth.api:sanctum')->name('user.')->prefix('user')->group(function(){
	    ...
	    Route::middleware(['checkStatusApi'])->group(function(){
            ...
            Route::get('order/{id}', 'UserController@orderDetails');
            Route::get('cashbacks', 'UserController@cashbacks');
            Route::get('cashback/balance', 'UserController@cashbackbalance');

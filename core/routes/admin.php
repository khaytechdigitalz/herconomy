...
Route::namespace('Admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        //Cashbacks
        Route::get('/cashback/all', 'OrderController@cashbackall')->name('cashback.all');
        Route::get('/cashback/admin', 'OrderController@cashbackadmin')->name('cashback.admin');
        ...
        Route::get('general/setting/tier', 'GeneralSettingController@tierindex')->name('setting.tiers');
        Route::post('general/setting/tier', 'GeneralSettingController@tiercreate');
        Route::post('general/setting/tier/update', 'GeneralSettingController@tierupdate')->name('setting.tier.update');
        Route::post('general/setting/tier/remove', 'GeneralSettingController@tierdelete')->name('setting.tier.remove');

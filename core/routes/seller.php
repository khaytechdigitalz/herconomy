...
Route::name('seller.')->namespace('Seller')->group(function () {
    ...
    Route::middleware('seller')->group(function () {
        ...
        Route::middleware('sellerCheckStatus')->group(function () {
            ...
            Route::get('/cashback', 'SellerController@cashback')->name('cashback');
            ...
            // Settlement
            Route::get('/settlement/settings', 'SellerController@settlementSettings')->name('settlement.settings');
            Route::post('/settlement/settings', 'SellerController@settlementSubmit');
            Route::get('/settlement/log', 'SellerController@settlementLog')->name('settlement.history');

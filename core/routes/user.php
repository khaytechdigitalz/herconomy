...
Route::name('user.')->group(function () {
    ...
    Route::get('affiliate', 'Auth\RegisterController@affiliate')->name('affiliate');
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::get('/product/review', 'UserController@productReviews')->name('product.review');
             ...
             // Orders
             Route::get('/cashback', 'UserController@cashback')->name('cashback');
            ...
            //Investment
            Route::get('/ref_log', 'UserController@ref_log')->name('ref_log');
            Route::get('/investment', 'UserController@invest')->name('invest');

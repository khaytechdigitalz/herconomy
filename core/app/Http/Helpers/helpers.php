...
function cashback()
{
    ...
    $cashback = Tier::orderBy('discount','Desc')->first();
    return number_format($cashback->discount,2).'%';
}

function systemDetails()
{
    $system['name'] = 'Herconomy';
...
function bpry()
{
    return "style='background-color: #F2BA00'";
}


function gradient()
{
    return "style= background:linear-gradient(135deg,#F2BA00,#000000); opacity: 0.0 - 1.0;";
}
function primarytext()
{
	$general = BasicControl::firstOrCreate(['id' => 1]);
    return "style= color:".$general->primaryColor.";";
}
function secondarytext()
{
	$general = BasicControl::firstOrCreate(['id' => 1]);
    return "style= color:".$general->secondaryColor.";";
} 

...
<div class="container">
    ...
    <div class="tab-content">
      ...
      <div id="menu1" class="tab-pane fade">
        ...
        <form method="POST" action="{{ route('api.loginHeconomy')}}" class="contact-form mb-30-none">
            @csrf

            <div class="contact-group">
                <label for="username">@lang('Email')</label>
                <input id="username" type="email" name="username" placeholder="@lang('Enter Your Username')" value="{{ old('username') }}">
            </div>

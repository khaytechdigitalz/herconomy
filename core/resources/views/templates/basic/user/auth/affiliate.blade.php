        ...
        <div class="row">
            <div class="col-lg-7 offset-lg-5">
                ...
                <div class="section-header left-style">
                    <h3 class="title">Become An Affiliate</h3>
                    <p>Please fill the form below to register an affiliate account and earn commision on purchase made by people your refer to {{$general->sitenama}}</p>
                </div>
                ...
                <form action="{{ route('user.register') }}" method="POST" onsubmit="return submitUserForm();">
                    ...
                    <input name="affiliate" value="1" hidden>

        ...
        <div class="row">
            <div class="col-lg-7 offset-lg-5">
                ...
                <form action="{{ route('user.register') }}" method="POST" onsubmit="return submitUserForm();">
                    ...
                    <hr>
                    <div class="contact-group">
                        <label for="username">@lang('Referrer')</label>
                        <div class="multi-group">
                            <input id="username" type="text" @if($refer != null) readonly @endif class="checkUser w-100" name="referrer" value="{{ (@$refer) }}" required>
                            <small class="text-info">This is an optinal field. Please leave blank if you were not refered by anybody</small>
                        </div>
                    </div>
                    <hr>

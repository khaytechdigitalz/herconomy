...
@section('content')
    ...
    <section class="vendor-products padding-bottom">
        <div class="container">
            ...
            @if($seller->shop->cashback_status == 1)
            <div class="cart-total section-bg mb-3" {{gradient()}}>
                <div class="m--15 d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <div class="total">
                        <div class="d-flex flex-wrap justify-content-between">
                            ...
                            <span class="amount"><span>@if($seller->shop->cashback_type == 'flat')<a>{{$general->cur_sym}}</a> @endif{{$seller->shop->cashback_amount}} @if($seller->shop->cashback_type == 'percentage')<a>%</a>@endif</span></span>
                        </div> 
                    </div>
                </div>
            </div>
                        ...
                        <div class="product-item-2-inner wish-buttons-in">
                            ...
                            <div class="product-content">
                                <div class="product-before-content">
                                    ...
                                    <hr>
                                    <div class="price">
                                    <small>@if($seller->shop->cashback_type == 'flat')<a>{{$general->cur_sym}}</a> @endif{{$seller->shop->cashback_amount}} @if($seller->shop->cashback_type == 'percentage')<a>%</a>@endif Cashback</small>
                                    </div>
                                    @endif

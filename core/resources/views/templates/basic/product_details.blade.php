...
@php
//$reffcode = request()->route('affiliate');
$reffcode =  @$_GET['affiliate'];
@endphp
@section('content')
        ...
        <div class="row product-details-wrapper">
            ...
            <div class="col-lg-7">
                <div class="product-details-content product-details">
                    ...
                    <small class="text-success"><b>Up to {{cashback()}} Cashback</b></small>
                        ...
                        <script>
                            (function($){
                                ...
                                $('.copytext').on('click',function(){
                                    ...
                                    iziToast.success({message: "Product Affliate Code Copied Successfuly", position: "topRight"});
                                });
                            })(jQuery);
                        </script>
                        @endpush

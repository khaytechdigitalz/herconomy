...
<div class="row mb-none-30">
    ...
    <div class="col-xl-6 col-md-6 mb-30">
        <div {{gradient()}} class="widget bb--3 border--success b-radius--10 bg--white p-4 box--shadow2 has--link">
            ...
            <div class="widget__content">
                <p class="text-uppercase text-white">@lang('Wallet Balance')</p>
    ...
    <div class="col-xl-6 col-md-6 mb-30">
        <div {{gradient()}} class="widget bb--3 border--danger b-radius--10 bg--white p-4 box--shadow2 has--link">
            <div class="widget__icon b-radius--rounded bg--danger"><i class="las la-cart-arrow-down"></i></div>
            <div class="widget__content">
                <p class="text-uppercase text-white">@lang('Pending Balance')</p>
                <h1 class="text--white font-weight-bold">
                    {{ $general->cur_sym.showAmount($pendingsettlement) }}
                </h1>
    ...
    <div class="col-xl-4 col-md-6 mb-30">
        <div {{gradient()}} class="widget bb--3 border--dark b-radius--10 bg--white p-4 box--shadow2 has--link">
            <div class="widget__icon b-radius--rounded bg--dark"><i class="las la-cart-arrow-down"></i></div>
            <div class="widget__content">
                <p class="text-uppercase text-white">@lang('Pending Orders')</p>
                <h1 class="text--white font-weight-bold">
                  {{$order['pending']}}
                </h1>
    ...
    <div class="col-xl-4 col-md-6 mb-30">
        <div {{gradient()}} class="widget bb--3 border--teal b-radius--10 bg--white p-4 box--shadow2 has--link">
            <div class="widget__icon b-radius--rounded bg--teal">
                <i class="las la-cart-arrow-down"></i>
            </div>
            <div class="widget__content">
                <p class="text-uppercase text-white">@lang('Proccessing Orders')</p>
    ...
    <div class="col-xl-4 col-md-6 mb-30">
        <div {{gradient()}} class="widget bb--3 border--light-blue b-radius--10 bg--white p-4 box--shadow2 has--link">
            <div class="widget__icon b-radius--rounded bg--light-blue">
                <i class="las la-cart-arrow-down"></i>
            </div>
            <div class="widget__content">
                <p class="text-uppercase text-white">@lang('Dispatched Orders')</p>
                <h1 class="text--white font-weight-bold">
                    {{$order['dispatched']}}
                </h1>
                <p class="mt-10 text-right">
    ...
    <div class="col-xl-4 col-md-6 mb-30">
        <div {{gradient()}} class="widget bb--3 border--success b-radius--10 bg--white p-4 box--shadow2 has--link">
            ...
            <div class="widget__content">
                <p class="text-uppercase text-white">@lang('Delivered Orders')</p>
                <h1 class="text--white font-weight-bold">
                    {{$order['dispatched']}}
                </h1>
    ...
    <div class="col-xl-4 col-md-6 mb-30">
        <div {{gradient()}} class="widget bb--3 border--danger b-radius--10 bg--white p-4 box--shadow2 has--link">
            ...
            <div class="widget__content">
                <p class="text-uppercase text-white">@lang('Cancelled Orders')</p>
                <h1 class="text--white font-weight-bold">
                    {{$order['cancelled']}}
                </h1>
                <p class="mt-10 text-right">
    ...
    <div class="col-xl-4 col-md-6 mb-30">
        <div {{gradient()}} class="widget bb--3 border--deep-purple b-radius--10 bg--white p-4 box--shadow2 has--link">
            <div class="widget__icon b-radius--rounded bg--deep-purple">
                <i class="las la-shipping-fast"></i>
            </div>
            <div class="widget__content">
                <p class="text-uppercase text-white">@lang('COD Orders')</p>
                <h1 class="text--white font-weight-bold">
                    {{$order['cod']}}
                </h1>
                <p class="mt-10 text-right">
    ...
    <div class="col-xl-4 col-md-6 mb-30">
        <div {{gradient()}} class="widget bb--3 border--indigo b-radius--10 bg--white p-4 box--shadow2 has--link">
            <div class="widget__icon b-radius--rounded bg--indigo">
                <i class="las la-tshirt"></i>
            </div>
            <div class="widget__content">
                <p class="text-uppercase text-white">@lang('Approved Products')</p>
                <h1 class="text--white font-weight-bold">
                    {{$product['approved']}}
                </h1>
                <p class="mt-10 text-right">
    ...
    <div class="col-xl-4 col-md-6 mb-30">
        <div {{gradient()}} class="widget bb--3 border--orange b-radius--10 bg--white p-4 box--shadow2 has--link">
            <div class="widget__icon b-radius--rounded bg--orange">
                <i class="las la-hourglass-end"></i>
            </div>
            <div class="widget__content">
                <p class="text-uppercase text-white">@lang('Pending Products')</p>
                <h1 class="text--white font-weight-bold">
                    {{$product['pending']}}
                </h1>
                <p class="mt-10 text-right">
    ...
    <div class="col-xl-4 col-md-6 mb-30">
        <div {{gradient()}} class="widget bb--3 border--black b-radius--10 bg--white p-4 box--shadow2 has--link">
            <div class="widget__icon b-radius--rounded bg--black">
                <i class="las la-file-invoice-dollar"></i>
            </div>
            <div class="widget__content">
                <p class="text-uppercase text-white">@lang('Total Sold')</p>
                <h1 class="text--white font-weight-bold">
                    {{$product['total_sold']}}
                </h1>
                <p class="mt-10 text-right">

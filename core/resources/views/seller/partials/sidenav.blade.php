    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('seller.cashback')}}">
                    <a href="{{route('seller.cashback')}}" class="nav-link ">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('seller.settlement*', 3)}}">
                        <i class="menu-icon la la-wallet"></i>
                        <span class="menu-title">@lang('Settlement')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('seller.settlement*', 2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive(['seller.settlement.settings']) }}">
                                <a class="nav-link" href="{{ route('seller.settlement.settings') }}">
                                    <i class="menu-icon la la-money"></i>
                                    <span class="menu-title">@lang('Settlement Settings')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('seller.settlement.history') }}">
                                <a class="nav-link" href="{{ route('seller.settlement.history') }}">
                                    <i class="menu-icon las la-history"></i>
                                    <span class="menu-title">@lang('Settlement Log')</span>
                                </a>
                            </li>
                        </ul>
                    </div>

...
@section('panel')
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="card mt-3">
            <div class="card-header"><h5 class="card-title mb-0">@lang('Cashback')</h5></div>

            <div class="card-body">
                <div class="form-group row">
                    <div class="col-md-3">
                        <label class="font-weight-bold">@lang('Cashback Type')</label>
                    </div>  
                    <div class="col-md-9">
                        <select type="text" class="form-control" name="cashback_type" value="{{ old('cashback_type')??@$shop->cashback_type }}">
                            <option selected disabled>Select Type</option>
                            <option @if(@$shop->cashback_type == 'flat')  selected @endif value="flat" disabled >Flat</option>
                            <option @if(@$shop->cashback_type == 'percentage') selected @endif value="percentage" >Percentage</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-3">
                        <label class="font-weight-bold">@lang('Cashback')</label>
                    </div>  
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="cashback_amount" value="{{ old('cashback_amount')??@$shop->cashback_amount }}" placeholder="@lang('0.00')">
                    </div>
                </div>

                <div class="form-group row">
                    <div class="col-md-3">
                        <label class="font-weight-bold">@lang('Cashback Status')</label>
                    </div>  
                    <div class="col-md-9">
                        <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')" data-off="@lang('Disabled')" @if(@$shop->cashback_status) checked @endif name="cashback_status">
                    </div>
                </div>

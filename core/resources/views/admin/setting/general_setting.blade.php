                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label font-weight-bold">@lang('Referrer Reward') (%)</label>
                                    <input class="form-control form-control-lg" type="text" name="upline_reward" value="{{$general->upline_reward}}">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label font-weight-bold">@lang('Referree Reward')  (%)</label>
                                    <input class="form-control form-control-lg" type="text" name="downline_reward" value="{{$general->downline_reward}}">
                                </div>
                            </div>
                            {{--}}

                            <div class="col-lg-3">
                                <label class="form-control-label font-weight-bold" data-toggle="tooltip" title="@lang("Admin will get the commission from the sellers' cashback setup.")"> @lang('Cashback Commission') </label>

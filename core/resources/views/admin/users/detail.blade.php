            ...
            <div class="row mb-none-30">
                <div class="col-xl-12 col-lg-12 col-sm-12 mb-30">
                    ...
                    <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                        <div {{gradient()}} class="dashboard-w1 bg--deep-purple b-radius--10 box-shadow has--link">
                    ...
                    <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                        <div {{gradient()}} class="dashboard-w1 bg--indigo b-radius--10 box-shadow has--link">
                    ...
                    <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                        <div {{gradient()}} class="dashboard-w1 bg--12 b-radius--10 box-shadow has--link">

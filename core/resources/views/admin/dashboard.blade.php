    ...
    <div class="row mb-none-30">
        ...
        <div class="col-md-6 mb-30">
            <div class="dashboard-w1 bg--info b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$general->cur_sym}}{{showAmount($widget['all_cashback'])}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Customers\' Cashbacks')</span>
                    </div>
                    <a href="{{route('admin.cashback.all')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        ...
        <div class="col-md-6 mb-30">
            <div class="dashboard-w1 bg--primary b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$general->cur_sym}} {{showAmount($widget['admin_cashback'])}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Admins Cashbacks')</span>
                    </div>
                    <a href="{{route('admin.cashback.admin')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
